    ...
    <div className="w-full h-screen bg-zinc-200 p-1">
      <div className="w-[60vw] h-[80vh] p-5 mx-auto mt-10 upload rounded-lg flex flex-col justify-center">
        ...
        <div className="w-full h-[85%] flex flex-col items-center justify-evenly">
          <div className="w-full p-4 border border-black rounded-lg flex items-center justify-between relative ">
            <input
              type="file"
        ...
        {fileUrl && (
          <div>
            <Link
              ...
              className="link-button text-2xl text-white hover:text-blue-500 underline decoration-solid"
            >
              Access your file here
            </Link>
            {account && <p className="text-xl w-52 font-medium text-white">Uploaded : {account}</p>}
